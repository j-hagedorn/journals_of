...
Some of these have distinct, smaller clusters of themes congealed within them, so it is worth dwelling on each in greater detail

# 

The first set of themes which seem to cluster together are those about the essence of blood.  Blood is seen as a material which is vital and numinous.  Vital, in that it has in it a creative power of life itself.  It is related to and in some instances constitutes the substance of soul/spirit, whatever that may be.  E.g. for the Greeks, the *soul* was not merely a wisp but the patterning power which governed the unfolding and development of the body. Blood is shown in this way in motifs 
